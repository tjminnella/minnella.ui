...
export const SuperheroForm = () => {
    ...
    const handlePowersChange = (e: ChangeEvent<HTMLInputElement>) => {
        const { value, checked } = e.target;
        setPowers(prev => (checked ? [...prev, value] : prev.filter(p => p !== value)));
    }
        ...
        <div className='form-wrap'>
            ...
            <form method='post' action='https://superhero-application-form.freecodecamp.org'>
                ...
                <button
                    ...
                    type='submit'
                    disabled={!heroName || !realName || !powerSource || !powers.length}
                >
                    Join the League
                </button>
            </form>
